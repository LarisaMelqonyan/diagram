...
const hotEntries = ["react-hot-loader/patch", "webpack-hot-middleware/client"];

// Update config entry and output
config[1].entry = {
  bundle: [...hotEntries, "./src/main.js"],
  demos: [...hotEntries, "./demos/index.js"],

  demo3: [...hotEntries, "./demos/demo3/index.js"]
};
...
// Add plugins
config[1].plugins = [new webpack.HotModuleReplacementPlugin()];
...
app.get("/demos/:name", (req, res) => {
  const body = fs
    ...
    .replace(
      "${SCRIPTS}",
      '<script src="/dist/bundle.js"></script><script src="/dist/' +
        req.params.name +
        '.js"></script>'
    );
  res.set("content-type", "text/html");
